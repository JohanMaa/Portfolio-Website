...
export default function PortfolioShowcase() {
  ...
  return (
    ...
    >
      ...
      {/* Tab Navigation */}
      <div className="relative z-10 max-w-xl mx-auto flex flex-col sm:flex-row justify-center items-center gap-4 bg-white/5 border border-white/10 rounded-2xl p-4 backdrop-blur">
        {tabs.map((tab) => (
          <button
            key={tab.name}
      ...
      {/* Dynamic Content */}
      <div className="relative z-10 mt-8 max-w-6xl mx-auto min-h-[300px]">
